...
export const buildAssetTypeCreatePayloadFromModel = (data: AssetTypeFormModel, userId: number = 0) => ({
...
export const buildAssetTypeUpdatePayloadFromModel = (data: AssetTypeFormModel, userId: number = 0) => ({
  id: data.id ?? 0,
  typeCode: data.typeCode.trim(),
  typeName: data.typeName.trim(),
  assetCategoryId: data.categoryId,
...
export const buildAssetCategoryCreatePayloadFromModel = (data: AssetCategoryFormModel, userId: number = 0) => ({
...
export const buildAssetCategoryUpdatePayloadFromModel = (data: AssetCategoryFormModel, userId: number = 0) => ({
  id: data.id ?? 0,
  categoryCode: data.categoryCode.trim(),
  categoryName: data.categoryName.trim(),
  description: (data.description ?? '').trim(),
