  ...
  if (activeTab !== 'property') {
    ...
    return (
      <div className="shrink-0 bg-white border border-[#002fbe]/25 rounded-lg p-2.5 flex flex-col justify-between shadow-md select-none w-full mt-1">
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-3 gap-y-1.5 text-[8.5px]">
            ...
            <div className="space-y-1.5 sm:border-l sm:border-gray-100 sm:pl-3 font-bold">
              ...
              <div className="flex items-center justify-between"><span className="flex items-center gap-1 text-gray-655"><AlertTriangle size={10} className="text-blue-500 fill-blue-55" /><span>Boundary Wall Missing</span></span><span className="bg-[#ecfdf5] text-[#10b981] border border-[#10b981]/20 font-bold px-1.5 py-0.5 rounded text-[8px]">Low</span></div>
        ...
        <button id="ai-view-report-btn-full" onClick={onViewReportClick} aria-expanded={aiReportPopupOpen} aria-controls="ai-report-popup" className="w-full mt-2 py-1 bg-[#edf2ff] hover:bg-[#dbeafe] border border-[#3b82f6]/20 text-[#3b82f6] font-extrabold text-[8.5px] rounded transition-all text-center cursor-pointer shadow-xs shrink-0">View All Report</button>
      </div>
    );
  }
    ...
    <div className="shrink-0 grid grid-cols-5 gap-3 mt-1 items-stretch">
      ...
      <div className="col-span-3 grid grid-cols-2 gap-3 overflow-hidden items-stretch">
        ...
        <div className="bg-white border border-[#002fbe]/25 rounded-lg p-2.5 flex flex-col justify-between shadow-md select-none h-full">
          ...
          <button id="ai-view-report-btn-half" onClick={onViewReportClick} aria-expanded={aiReportPopupOpen} aria-controls="ai-report-popup" className="w-full mt-2 py-1 bg-[#edf2ff] hover:bg-[#dbeafe] border border-[#3b82f6]/20 text-[#3b82f6] font-extrabold text-[8.5px] rounded transition-all text-center cursor-pointer shadow-xs shrink-0">View All Report</button>
        </div>
