...
export default function MainContent() {
  ...
  const [activeDiscountSubTab, setActiveDiscountSubTab] = useState<'discount' | 'social'>('discount');
  ...
  const kycData = {
    ...
    occupierNameMarathi: "अश्विन सांगळे",
    occupierName: "Ashwin Sangle",
    shopNameMarathi: "अश्विन सांगळे",
    shopName: "Ashwin Sangle",
    aadharCardNo: "9820-2212-0012",
    mobileNumber: "9685746352",
      ...
      <div className="flex-1 min-h-0 flex gap-2.5 overflow-hidden">
        ...
        <div className="flex-1 min-h-0 flex flex-col gap-2 overflow-hidden">
          ...
          <div className="flex-1 min-h-0 bg-white border border-gray-200 rounded-lg p-2.5 shadow-sm flex flex-col overflow-y-auto no-scrollbar gap-2">
            ...
            {(activeTab === 'property' || activeTab === 'building') && (
            ...
            {/* PANEL 2: KYC Details */}
            {activeTab === 'kyc' && (
              <div className="flex flex-col gap-2 transition-all duration-300 animate-fadeIn p-1">
                <div className="flex items-center justify-between pb-1 shrink-0 select-none border-b border-gray-150 mb-2">
                  <h3 className="font-extrabold text-[#002fbe] text-[11px] uppercase tracking-wider">KYC Details</h3>
                </div>
                <div className="flex-grow grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-x-5 gap-y-3.5 text-[10px] leading-tight pt-1">
            ...
            {/* PANEL 3: Society Details */}
            {activeTab === 'society' && (
              <div className="flex flex-col gap-2 transition-all duration-300 animate-fadeIn p-1">
                <div className="flex items-center justify-between pb-1 shrink-0 select-none border-b border-gray-150 mb-2">
                  <h3 className="font-extrabold text-[#002fbe] text-[11px] uppercase tracking-wider">Society Details</h3>
                </div>
                <div className="flex-grow grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-x-5 gap-y-3.5 text-[10px] leading-tight pt-1">
            ...
            {/* PANEL 4: Discount & Social Data */}
            {activeTab === 'discount' && (
              <div className="flex flex-col gap-2 transition-all duration-300 animate-fadeIn p-1 w-full">
                <div className="flex items-center justify-between pb-1 shrink-0 select-none border-b border-gray-150 mb-2">
                  <h3 className="font-extrabold text-[#002fbe] text-[11px] uppercase tracking-wider">Discount & Social Data</h3>
                </div>
                
                <div className="flex flex-col xl:flex-row gap-4 text-[10px] leading-tight self-start w-full">
                  {/* Left Area (Sewage Treatment Plant & Active Sub-tab) */}
                  <div className="flex-1 flex flex-col gap-3 min-w-0">
                    
                    {/* Sewage Treatment Plant controls box */}
                    <div className="bg-[#eff6ff]/35 border border-blue-100 rounded-lg p-2.5 flex flex-col gap-2 relative">
                      {/* Header row */}
                    ...
                    <div className="flex-grow pt-1">
                      {activeDiscountSubTab === 'discount' ? (
                        /* Discount Data content */
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-5 gap-y-3.5 w-full animate-fadeIn">
                  ...
                  <div className="flex flex-row xl:flex-col gap-2 shrink-0 justify-start pt-1 xl:border-l xl:border-blue-100/50 xl:pl-4">
                    <button
                      onClick={() => setActiveDiscountSubTab('discount')}
                      className={`px-3 py-1.5 text-[9.5px] font-extrabold rounded-lg border text-center transition-all cursor-pointer w-full md:w-32 xl:w-28 ${activeDiscountSubTab === 'discount' ? 'bg-[#002fbe] text-white border-[#002fbe] shadow-sm' : 'bg-white text-[#002fbe] border-gray-250 hover:bg-gray-50'}`}
                    >
                      Discount Data
                    </button>
                    <button
                      onClick={() => setActiveDiscountSubTab('social')}
                      className={`px-3 py-1.5 text-[9.5px] font-extrabold rounded-lg border text-center transition-all cursor-pointer w-full md:w-32 xl:w-28 ${activeDiscountSubTab === 'social' ? 'bg-[#002fbe] text-white border-[#002fbe] shadow-sm' : 'bg-white text-[#002fbe] border-gray-250 hover:bg-gray-50'}`}
                    >
                      Social Data
                    </button>
                  </div>
            ...
            {activeTab === 'old' && (
              <div className="flex flex-col gap-2 transition-all duration-300 animate-fadeIn p-1 w-full">
                <div className="flex items-center justify-between pb-1 shrink-0 select-none border-b border-gray-155 mb-2">
                  <h3 className="font-extrabold text-[#002fbe] text-[11px] uppercase tracking-wider">Old Details</h3>
                </div>
                
                {/* Old Details Grid */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-x-[28px] gap-y-3.5 text-[10px] leading-tight pt-1">
