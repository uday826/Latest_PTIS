          ...
          <div className="flex flex-wrap items-end gap-3">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (val === "") {
                    ...
                    setGenCount(Math.max(1, Number(val)));
                  }
                }}
            ...
            <div className="w-44">
              <button
                ...
                disabled={isGenerating || !genType || !genCount || Number(genCount) < 1}
                className={`w-full h-8 rounded-lg text-[10px] font-black uppercase tracking-wider flex items-center justify-center gap-1 transition-colors shadow-sm ${isGenerating || !genType || !genCount || Number(genCount) < 1
