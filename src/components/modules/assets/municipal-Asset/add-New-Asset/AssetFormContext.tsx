          ...
          if (dbAsset) {
            setFormData(prev => {
              ...
              const updatedData = {
                ...
                zone: dbAsset.zoneId ? String(dbAsset.zoneId) : prev.zone,
                ward: dbAsset.wardId ? String(dbAsset.wardId) : prev.ward,
                department: dbAsset.departmentId ? String(dbAsset.departmentId) : prev.department,
