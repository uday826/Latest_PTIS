...
import { InventoryCategoryMasterTable } from './InventoryCategoryMasterTable';

export function InventoryCategoryMasterView(props: MasterDataCommonProps) {
  const {
    master,
    selectedMaster,
    selectedGroup,
