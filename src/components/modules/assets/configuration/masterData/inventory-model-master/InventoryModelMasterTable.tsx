...
import { InventoryModelMasterForm } from './InventoryModelMasterForm';

export function InventoryModelMasterTable({
  master,
  selectedGroup,
  onDelete,
  onSave,
  ...
  const columns = useMemo(
    (): Column<MasterDataRecord>[] => [
      ...
      {
        key: 'group',
        label: t('configuration.masterData.form.labels.itemName').toUpperCase(),
        width: '30%',
        render: (v, row) => {
          const resolvedName =
