...
import { OwningDepartmentMasterForm } from './OwningDepartmentMasterForm';
...
export function OwningDepartmentMasterTable({ master, selectedGroup, onDelete, onSave, isPending = false, pagination, departmentOptions }: MasterTableRecordProps & { pagination: PaginationConfig; departmentOptions: Option[] }) {
  const t = useTranslations('owningDepartment.configuration.masterData.form.labels');
