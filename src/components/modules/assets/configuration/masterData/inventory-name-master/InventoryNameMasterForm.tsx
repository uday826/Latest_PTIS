...
export function InventoryNameMasterForm({
  open,
  onClose,
  onSave,
  editData,
  ...
  const tNames = useTranslations('inventoryName.masterNames');
  const tErrors = useTranslations('inventoryName.configuration.masterData.form.errors');
