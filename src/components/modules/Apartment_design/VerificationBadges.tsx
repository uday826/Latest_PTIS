...
export default function VerificationBadges() {
  return (
    <div className="bg-white px-2.5 py-1 rounded-lg border border-gray-200 shadow-sm text-[10px] flex items-center justify-between gap-x-1.5 shrink-0 select-none mb-2.5 h-[40px] xl:h-[42px] overflow-x-auto no-scrollbar whitespace-nowrap w-full">
