                ...
                <tbody className="divide-y divide-gray-150 font-medium text-[#1e2b58] whitespace-nowrap bg-white text-center">
                  <tr className="bg-white hover:bg-[#edf2ff]/30 transition-colors duration-150">
                    <td className="py-1.5 px-2 text-left sticky left-0 bg-white border-r border-[#002fbe]/10 z-10">
                      <span className="bg-[#eff6ff] text-blue-600 border border-blue-200 font-bold px-2 py-0.5 rounded text-[7.5px] inline-block text-center uppercase tracking-wider shadow-2xs font-extrabold">Old Taxes</span>
                    </td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    ...
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    <td className="py-1.5 px-2 text-[#1e2b58]/35 font-bold">0</td>
                  </tr>
                  <tr className="bg-[#edf2ff]/10 hover:bg-[#edf2ff]/30 transition-colors duration-150">
                    <td className="py-1.5 px-2 text-left sticky left-0 bg-[#fbfdff] border-r border-[#002fbe]/10 z-10">
                      <span className="bg-[#edf2ff] text-blue-700 border border-blue-300 font-bold px-2 py-0.5 rounded text-[7.5px] inline-block text-center uppercase tracking-wider shadow-2xs font-extrabold">RV Taxes</span>
                    </td>
                  ...
                  <tr className="bg-[#f5f3ff]/15 hover:bg-[#f5f3ff]/35 transition-colors duration-150 font-bold">
                    <td className="py-1.5 px-2 text-left sticky left-0 bg-[#fcfbfe] border-r border-[#002fbe]/10 z-10">
                      <span className="bg-[#f5f3ff] text-purple-700 border border-purple-300 font-bold px-2 py-0.5 rounded text-[7.5px] inline-block text-center uppercase tracking-wider shadow-2xs font-extrabold">CV Taxes</span>
                    </td>
                  ...
                  <tr className="bg-[#fffbfa]/30 hover:bg-[#edf2ff]/30 transition-colors duration-150">
                    <td className="py-1.5 px-2 text-left sticky left-0 bg-[#fffdfd] border-r border-[#002fbe]/10 z-10">
                      <span className="bg-[#fef2f2] text-red-600 border border-red-200 font-bold px-2 py-0.5 rounded text-[7.5px] inline-block text-center uppercase tracking-wider shadow-2xs font-extrabold">Retain U.S. 129</span>
                    </td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
                    <td className="py-1.5 px-2 border-r border-[#002fbe]/10 text-[#1e2b58]/35 font-bold">0</td>
